<template>
    <div style="width: 100%; height: 100%; margin: 0; border: 0; padding: 0;">
        ...
        <div v-else>
            <slot>
                Your browser does not seem to support <a
    ...
    export default {
        ...
        methods: {
            ...
            updateModel() {
                ...
                const {rotation} = this;
                const {scale} = this;
                const scaleValue = this.getFitScaleValue(object);
                object.position.set(position.x, position.y+0.5, position.z);
                object.rotation.set(rotation.x , rotation.y+.55, rotation.z);
                object.scale.set(scaleValue / 2, scaleValue / 2, scaleValue / 2);
            },
